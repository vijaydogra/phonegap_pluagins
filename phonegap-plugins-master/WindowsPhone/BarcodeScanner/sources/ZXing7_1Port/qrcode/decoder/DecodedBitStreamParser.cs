	...
	sealed class DecodedBitStreamParser
	{
		...
		private static void  decodeKanjiSegment(BitSource bits, System.Text.StringBuilder result, int count)
		{
			...
			try
			{
                ...
                // result.Append(System.Text.Encoding.GetEncoding(SHIFT_JIS).GetString(SupportClass.ToByteArray(buffer))); // commented by .net follower (http://dotnetfollower.com)
                byte[] inputBytes = SupportClass.ToByteArray(buffer); // added by .net follower (http://dotnetfollower.com)
                result.Append(System.Text.Encoding.GetEncoding(SHIFT_JIS).GetString(inputBytes, 0, inputBytes.Length)); // added by .net follower (http://dotnetfollower.com)
			}
        ...
        // private static void  decodeByteSegment(BitSource bits, System.Text.StringBuilder result, int count, CharacterSetECI currentCharacterSetECI, System.Collections.ArrayList byteSegments) // commented by .net follower (http://dotnetfollower.com)
        private static void decodeByteSegment(BitSource bits, System.Text.StringBuilder result, int count, CharacterSetECI currentCharacterSetECI, System.Collections.Generic.List<Object> byteSegments) // added by .net follower (http://dotnetfollower.com)
		{
			...
			{
				//UPGRADE_TODO: The differences in the Format  of parameters for constructor 'java.lang.String.String'  may cause compilation errors.  "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1092'"
                // result.Append(System.Text.Encoding.GetEncoding(encoding).GetString(SupportClass.ToByteArray(readBytes))); // commented by .net follower (http://dotnetfollower.com)
                byte[] inputBytes = SupportClass.ToByteArray(readBytes); // added by .net follower (http://dotnetfollower.com)
                result.Append(System.Text.Encoding.GetEncoding(encoding).GetString(inputBytes, 0, inputBytes.Length)); // added by .net follower (http://dotnetfollower.com)
			}
