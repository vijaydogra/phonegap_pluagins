...
namespace com.google.zxing
{
	...
	public sealed class Result
	{
		...
		/// like orientation.
		/// </returns>
        // public System.Collections.Hashtable ResultMetadata // commented by .net follower (http://dotnetfollower.com)
        public System.Collections.Generic.Dictionary<Object, Object> ResultMetadata // added by .net follower (http://dotnetfollower.com)
		{
			get
			{
        ...
        // private System.Collections.Hashtable resultMetadata; // commented by .net follower (http://dotnetfollower.com)
        private System.Collections.Generic.Dictionary<Object, Object> resultMetadata; // added by .net follower (http://dotnetfollower.com)
		...
		public void  putMetadata(ResultMetadataType type, System.Object value_Renamed)
		{
			...
			{
                // resultMetadata = System.Collections.Hashtable.Synchronized(new System.Collections.Hashtable(3)); // commented by .net follower (http://dotnetfollower.com)
                resultMetadata = new System.Collections.Generic.Dictionary<Object, Object>(3); // added by .net follower (http://dotnetfollower.com)
			}
