...
namespace com.google.zxing
{
	...
	public sealed class MultiFormatReader : Reader
	{
        ...
        public System.Collections.Generic.Dictionary<Object, Object> Hints // added by .net follower (http://dotnetfollower.com)
		{
			set
			{
				this.hints = value;
                ...
                System.Collections.Generic.List<Object> formats = null; // added by .net follower (http://dotnetfollower.com)
                if (value != null && value.ContainsKey(DecodeHintType.POSSIBLE_FORMATS)) // added by .net follower (http://dotnetfollower.com)
                    formats = (System.Collections.Generic.List<Object>)value[DecodeHintType.POSSIBLE_FORMATS]; // added by .net follower (http://dotnetfollower.com)
        ...
        private System.Collections.Generic.Dictionary<Object, Object> hints; // added by .net follower (http://dotnetfollower.com)
