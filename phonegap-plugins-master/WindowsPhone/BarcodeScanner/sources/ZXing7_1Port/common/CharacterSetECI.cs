...
namespace com.google.zxing.common
{
	...
	public sealed class CharacterSetECI:ECI
	{
        ...
        // private static System.Collections.Hashtable VALUE_TO_ECI; // commented by .net follower (http://dotnetfollower.com)
        private static System.Collections.Generic.Dictionary<Object, Object> VALUE_TO_ECI; // added by .net follower (http://dotnetfollower.com)
        // private static System.Collections.Hashtable NAME_TO_ECI; // commented by .net follower (http://dotnetfollower.com)
        private static System.Collections.Generic.Dictionary<Object, Object> NAME_TO_ECI; // added by .net follower (http://dotnetfollower.com)
		
		private static void  initialize()
		{
            // VALUE_TO_ECI = System.Collections.Hashtable.Synchronized(new System.Collections.Hashtable(29)); // commented by .net follower (http://dotnetfollower.com)
            VALUE_TO_ECI = new System.Collections.Generic.Dictionary<Object, Object>(29); // added by .net follower (http://dotnetfollower.com)
            // NAME_TO_ECI = System.Collections.Hashtable.Synchronized(new System.Collections.Hashtable(29)); // commented by .net follower (http://dotnetfollower.com)
            NAME_TO_ECI = new System.Collections.Generic.Dictionary<Object, Object>(29); // added by .net follower (http://dotnetfollower.com)
