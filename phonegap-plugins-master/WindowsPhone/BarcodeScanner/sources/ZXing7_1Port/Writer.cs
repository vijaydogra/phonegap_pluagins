...
namespace com.google.zxing
{
	...
	public interface Writer
	{
		...
		/// <returns> The generated barcode as a Matrix of unsigned bytes (0 == black, 255 == white)
		/// </returns>
        // ByteMatrix encode(System.String contents, BarcodeFormat format, int width, int height, System.Collections.Hashtable hints); // commented by .net follower (http://dotnetfollower.com)
        ByteMatrix encode(System.String contents, BarcodeFormat format, int width, int height, System.Collections.Generic.Dictionary<Object, Object> hints); // added by .net follower (http://dotnetfollower.com)
	}
}