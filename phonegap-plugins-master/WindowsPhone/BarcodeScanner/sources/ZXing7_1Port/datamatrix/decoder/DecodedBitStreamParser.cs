...
namespace com.google.zxing.datamatrix.decoder
{
	...
	sealed class DecodedBitStreamParser
	{
        ...
        //private static void  decodeBase256Segment(BitSource bits, System.Text.StringBuilder result, System.Collections.ArrayList byteSegments) // commented by .net follower (http://dotnetfollower.com)
        private static void decodeBase256Segment(BitSource bits, System.Text.StringBuilder result, System.Collections.Generic.List<Object> byteSegments) // added by .net follower (http://dotnetfollower.com)
		{
			...
			try
			{
                ...
                // result.Append(System.Text.Encoding.GetEncoding("ISO8859_1").GetString(SupportClass.ToByteArray(bytes))); // commented by .net follower (http://dotnetfollower.com)
                byte[] inputBytes = SupportClass.ToByteArray(bytes); // added by .net follower (http://dotnetfollower.com)
                result.Append(System.Text.Encoding.GetEncoding("ISO8859_1").GetString(inputBytes, 0, inputBytes.Length)); // added by .net follower (http://dotnetfollower.com)
			}
