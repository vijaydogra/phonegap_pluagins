...
namespace com.google.zxing.client.result
{
	...
	sealed class SMSMMSResultParser:ResultParser
	{
		...
		public static SMSParsedResult parse(Result result)
		{
            ...
            // System.Collections.Hashtable nameValuePairs = parseNameValuePairs(rawText); // commented by .net follower (http://dotnetfollower.com)
            System.Collections.Generic.Dictionary<Object, Object> nameValuePairs = parseNameValuePairs(rawText); // added by .net follower (http://dotnetfollower.com)
