...
namespace com.google.zxing.client.result
{
	...
	sealed class AddressBookAUResultParser:ResultParser
	{
		...
		{
            // System.Collections.ArrayList values = null; // commented by .net follower (http://dotnetfollower.com)
            System.Collections.Generic.List<Object> values = null; // added by .net follower (http://dotnetfollower.com)
			for (int i = 1; i <= max; i++)
			{
				...
				if (values == null)
				{
                    // values = System.Collections.ArrayList.Synchronized(new System.Collections.ArrayList(max)); // lazy init // commented by .net follower (http://dotnetfollower.com)
                    values = new System.Collections.Generic.List<Object>(max); // lazy init // added by .net follower (http://dotnetfollower.com)
				}
