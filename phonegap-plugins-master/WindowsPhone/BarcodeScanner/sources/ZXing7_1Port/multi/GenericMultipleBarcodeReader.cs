...
namespace com.google.zxing.multi
{
	...
	public sealed class GenericMultipleBarcodeReader : MultipleBarcodeReader
	{
        ...
        private void doDecodeMultiple(BinaryBitmap image, System.Collections.Generic.Dictionary<Object, Object> hints, System.Collections.Generic.List<Object> results, int xOffset, int yOffset) // added by .net follower (http://dotnetfollower.com)
		{
			Result result;
			try
			{
